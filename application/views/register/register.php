...
<head>
	...
	<link type="text/css" href="<?php echo base_url()."assets"; ?>/css/register.css" rel="stylesheet">
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" name="registerForm" action="<?php echo base_url()."Register/addUser/register"; ?>" method="post">
