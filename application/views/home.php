...
<head>
    ...
    <!-- Stylesheets -->
    <link type="text/css" href="<?php echo base_url()."assets"; ?>/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link type="text/css" href="<?php echo base_url()."assets"; ?>/rondo/style.css" rel="stylesheet">
            ...
            <div class="splash-block">
                <div class="centered">
                    <div class="container">
                        ...
                        <a href="<?php echo base_url()."Register/index";?>" class="btn btn-outline btn-lg">Login  </a>&nbsp; <a href="#jump6"
                            class="btn btn-outline btn-lg">Or Register</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <li class="mix phone">
                    <div>
                        <div class="media-thumb">
                            <img src="<?php echo base_url()."assets"; ?>/img/portfolio/place-4.jpg">
